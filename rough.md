...
YouTube Video: https://www.youtube.com/watch?v=XZyapIKV3Rw
...
If you are a visual learner, also check out a great http.cat(opens in new tab) resource to study status codes. Now, click the "View Site" button on the right to see what some of these HTTP status messages look like in a browser.
